...
<head>
    ...
    $purchaseno = $purchaseObj->getPurchaseNo();
    if (mysqli_num_rows($purchaseno) > 0) {
        if ($pnorow= mysqli_fetch_assoc($purchaseno)) {
            $lastid = $pnorow['purchaseref_no'];
            $lastid = substr($lastid, 4, 8);//separating numeric part
            $lastid = $lastid + 1;//Incrementing numeric part
            $lastid = "REF-" . sprintf('%03s', $lastid);//concatenating incremented value
            $purchaseNo = $lastid;
        }
    }
    else {
   ...
   <!--Form Start-->
    <form  id="purchaseForm" enctype="multipart/form-data" method="post" action="../controller/purchasecontroller.php?status=add_email">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" id="purchaseref_no" name="purchaseref_no" class="form-control" autocomplete="off" value="<?php echo$purchaseNo ?>"/>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <input type="text"  class="form-control" autocomplete="off" id="pusup_id" name="pusup_id"  placeholder="Enter Supplier Name"  />
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" name="supplier_email" autocomplete="off" id="psupplier_email" />
            </div>
            <div class="col-md-3">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <textarea name="message" id="message" rows="4" class="form-control" required>Please supply your order to us within a week. Let us know if any delivery is difficult.
                </textarea>
            </div>
        </div>
        <hr>
        ...
        <div class="row">
            <table class="table table-bordered table-responsive" id="plist">
                ...
                <tr>
                    ...
                    <th><input id="ptotal" type="text" class="form-control-plaintext" name="ptotal" value="0.00" readonly="readonly"></th>
                </tr>
                </tfoot>
            </table>
        </div>
