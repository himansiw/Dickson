...
<head>
    ...
    $stockObj= new Stock();
    $stockResult=$stockObj->getAllExpired();
    ?>
</head>
<body>
<?php
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-lg-10">
            <center> <h2 class="page-header"><b>Expired Products</b></h2></center>
        </div>
        <div class="col-md-1">&nbsp;</div>
    </div>
    <div class="row">
            ...
            <div class="page-body">
                ...
                <div class="table-responsive center-block">
                    <table class="table table-bordered table-striped" id="example" role="grid"  style="float:left;">
                        ...
                        <?php
                        while ($erow = $stockResult->fetch_assoc()) {
                            $expireId = $erow["expire_id"];
                            $expireId = base64_encode($expireId);
                            ?>
                            <tr>
                                <td><?php echo $erow["expire_id"]; ?></td>
                                <td><?php echo date("M d, Y",strtotime($erow['date_created'])) ?></td>
                                <td><?php echo date("M d, Y",strtotime($erow['date_expired'])) ?></td>
                                <td><?php echo $erow["product_name"]; ?></td>
                                <td><?php echo $erow["pcode"]; ?></td>
                                <td><?php echo $erow["eqty"]; ?></td>
                                <td>
                                    <?php
                                    if ($erow["e_status"] == "1") {
                                        echo "Confirmed";
