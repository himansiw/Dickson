$(document).ready(function (){
    ...
    $("#add_plist").click(function(){
        ...
        row += "<td><a   href='javascript:void(0)' style='background-color: white; border: none;outline: none' class='text-danger remove'><span  arial-hidden='true'> &cross;</span></a></td>";
    ...
    $("#purchaseItem").on("click",".remove",function () {
